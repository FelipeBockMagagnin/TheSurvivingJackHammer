...
public class ManagerUi : MonoBehaviour {
	...
	void Update () {
        ...
        {
            HighScoreTxt.text = (HighScoreManager.HighScore).ToString();
        }
    ...
    public void EnableEndGamePanel()
    {
        ...
        EndGameTexts[3].text = ((HighScoreManager.HighScore)).ToString();
        EnableShowAdsMultiply();
        giveachivementStartGame();
    }
    ...
    {
        LeaderBoardPanel.GetComponent<Animator>().SetBool("active", true);
    }

    public void DisableLeaderBoardPanel()
    {
        LeaderBoardPanel.GetComponent<Animator>().SetBool("active", false);
    }
